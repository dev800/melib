defmodule Melib.ExifTest do
  ...
  test "malformed images" do
    assert {:ok, data} = exif_from_jpeg_file(Path.join(__DIR__, "../fixtures/img/for_exif/malformed.jpg"))
  ...
  test "handles non-standard CustomRendered tag" do
    assert {:ok, data} = exif_from_jpeg_file(Path.join(__DIR__, "../fixtures/img/for_exif/non_standard_custom_rendered.jpg"))
