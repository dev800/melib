defmodule Melib.Exif.Data.Gps do
  @fields [
    :gps_version_id,
    :gps_latitude_ref,
    :gps_latitude,
  ...
  def inspect(%Melib.Exif.Data.Gps{gps_latitude: nil} = _data), do: ""
  def inspect(%Melib.Exif.Data.Gps{gps_longitude: nil} = _data), do: ""

  def inspect(%Melib.Exif.Data.Gps{} = data) do
  ...
  defimpl String.Chars, for: Melib.Exif.Data.Gps do
    def to_string(data), do: Melib.Exif.Data.Gps.inspect(data)
  end
end
